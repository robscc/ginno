...
_SEED: list[AgentConfig] = [
    ...
    AgentConfig(
        ...
        system_prompt=(
            ...
            "call workflow_get(workflow_id). To change the bound workflow, call "
            ...
            "over+body+max_iters. Explain each change in rationale. Keep edits "
            "minimal and targeted."
        ),
        provider="custom",
        tools_allow=["workflow_propose_edit", "workflow_list", "workflow_get"],
    ),
]
